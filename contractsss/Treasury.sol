...
contract Treasury is Access {
    ...
    event Initiated(uint256 id, string name, address receiver, uint256 amount, uint256 timestamp);
    ...
    function addCharge(
        ...
        emit Initiated(_counters[dao_], name_, receiver_, amount_, block.timestamp);
        return true;
    }
